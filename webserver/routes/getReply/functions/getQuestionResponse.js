    ...
    User.findOne({
        ...
        session.run(query).then(function(resultObj) {
            ...
            // @sangeetha : recommendations keywords  for QuestionResponse
                ...
                if (flag == 1) {
                    answerObj.extras = 'Showing answerObjs for : ' +
              ...
              console.log('in question resonse answerobj '+JSON.stringify(answerObj));
              answerObjArray.push(answerObj);
              console.log('in question answerObjArray '+JSON.stringify(answerObjArray));
