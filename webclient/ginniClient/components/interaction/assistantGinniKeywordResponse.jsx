        ...
        return (
          ...
          <Feed id="ginniview">
                          ...
                          <Label.Group>
                              {this.props.data.video.length - 1 > 0
                                    ...
                                    trigger={<Label onClick={this.playVideo} basic color = 'orange' id = 'cursor' > Play video </Label>}>
                                      <Feed id='assistantView'>
                                          <Feed.Event>
                                              <Feed.Content>
                                                  <Feed.Extra >
                                                      <ReactPlayer height={455} width={810} url={this.props.data.video[0].value} playing={false} controls={true}/>
                                                  </Feed.Extra>
                                              </Feed.Content>
                                          </Feed.Event>
                                      </Feed>
                                  ...
                                  <AssistantGinniOptions question={this.props.question}
                                    type='video' value={video} likes={this.props.data.video[0].likes} dislikes ={this.props.data.video[0].dislikes}/>
                          </Label.Group>
                      </Feed.Extra>
                  </Feed.Content>
              </Feed.Event>
            ...
            /* @yuvashree: edited code for displaying blogs */
              ...
              console.log('keywordResponse '+ blog);
              return (
                <Feed id="ginniview">
              <Feed.Event>
                  <Feed.Content id = 'ginniviewKeyword'>
